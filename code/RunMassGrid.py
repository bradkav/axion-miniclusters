...
def run_AMC_mass(M_AMC):
    AMC_MF = mass_function.DeltaMassFunction(m_a=m_a, M0=M_AMC)
...
np.savetxt("../data/MassGrid.txt", np.c_[M_list, gamma_list, gamma_AS_list, T_lower_list, T_med_list, T_upper_list])
print("> Done")

...
M_list, gamma_list, gamma_AScut_list, T_lower_list, T_med_list, T_upper_list = np.loadtxt("../../data/MassGrid.txt", unpack=True)
...
plt.savefig("../../plots/EncounterRate_AMC_masses.pdf", bbox_inches='tight')
